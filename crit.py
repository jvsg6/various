...
def rg(title):
	...
	return grid
def printASCIIGRDFile(filename,countx, county, lonmin, lonmax, latmin, latmax, critArr):
		f = open(filename, 'wt')
		f.write("DSAA" + '\r\n')
...
def main():
	...
	for j in range(24, 197, 8):
		...
		for i in range(j, j+6):
			#print i+143
			lst.append(rg("/home/egor/quest/criticalGroup/GRD/f{}.grd".format(i)))
	...
	printASCIIGRDFile("crit.grd",countx, county, lonmin, lonmax, latmin, latmax,critArray )
